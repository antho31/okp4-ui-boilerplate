# Build a Web App on the OKP4 protocol

![Build a web interface with the OKP4 network](./src/assets/webapp-0.webp)
...
![Result with Connection component](./src/assets/webapp-1.webp)
...
![Connect to OKP4 with Metamask](./src/assets/webapp-2.webp)
...
![Result with Balance component](./src/assets/webapp-3.webp)
...
![Result with Instantiate component](./src/assets/webapp-4.webp)
...
![Result with Execute component](./src/assets/webapp-5.webp)
...
![Result with Transactions component](./src/assets/webapp-6.webp)
...
![Vite UI boilerplate final (connected to OKP4 network)](./src/assets/webapp-7.webp)
